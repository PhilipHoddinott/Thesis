%{
function [outputArg1,outputArg2] = rv_from_r0v0(inputArg1,inputArg2)
%RV_FROM_R0V0 Summary of this function goes here
...
kepler_U, f_and_g, fDot_and_gDot 
%} 
% ----------------------------------------------   
mu = 398600; 
...
R = f*R0 + g*V0;   %...Compute the magnitude of R: 
r = norm(R);   
